...
public class ConvertOneStringToAnotherDP {
    ...
    public static void main(String[] args) {
        ConvertOneStringToAnotherDP convertOneStringToAnother = new ConvertOneStringToAnotherDP();
        System.out.println(convertOneStringToAnother.findMinOperationsTD("table", "tbres"));
